...
/**
 * shell版：
 * scan 'TEST1', {FILTER => "ValueFilter(=,'binary:zhangsan')" }
 * scan 'TEST1', {FILTER => "ValueFilter(=,'substring:1')" }
 */
public class ValueFilterSample {
    ...
    private static Filter getFilter() {
        return new ValueFilter(
                ...
                new BinaryComparator(Bytes.toBytes("men")));
    }
}

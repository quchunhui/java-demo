 ...
 */
public class FirstKeyValueMatchingQualifiersFilterSample {
    ...
    private static Filter getFilter() {
        Set<byte[]> qualifiers = new HashSet<>();
        qualifiers.add(Bytes.toBytes("adfa"));
        qualifiers.add(Bytes.toBytes("name"));
